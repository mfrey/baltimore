...
def main():
    ...
    # check if the configuration file argument has been set 
    if arguments.configuration.endswith("ini"):
        ...
        experiment_manager.process(configuration.settings['cwd'] + '/results', self.settings['scenarios'], arguments.verbose, arguments.network)
