...
#    parser.add_argument('-n', dest='network', default=False, const=True, action='store_const', help="print ")
    parser.add_argument('-s', dest='scenario', type=str, default="", action='store', help="evaluate a specific scenario")
    arguments = parser.parse_args()
    
    experiment_manager = ExperimentManager()
    experiment_manager.process(arguments.directory, arguments.scenario, arguments.verbose)
