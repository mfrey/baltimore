...
def main():
    ...
    parser.add_argument('-c', '--config', dest='configuration', type=str, default="", action='store', help='a configuarion file for baltimore')
    parser.add_argument('-d', '--dir', dest='directory', type=str, default="", action='store', help='a directory which contains OMNeT++ result files')
    ...
    parser.add_argument('-s', '--scenario', dest='scenario', type=str, default="", action='store', help="evaluate a specific scenario")
